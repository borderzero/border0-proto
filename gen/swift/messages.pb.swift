...
struct Border0_Common_V1_DiscoveryDetailsMessage: Sendable {
  ...
  var wgEndpointAddrs: [Border0_Common_V1_WireGuardEndpointAddr] = []
...
struct Border0_Common_V1_WireGuardPeer: Sendable {
  ...
  /// all ip address and port combinations that the peer can tx/rx traffic
  var addresses: [Border0_Common_V1_WireGuardEndpointAddr] = []
...
extension Border0_Common_V1_DiscoveryDetailsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}discoverable\0\u{3}endpoint_public_udp4\0\u{3}endpoint_public_udp6\0\u{3}public_key\0\u{3}wg_endpoint_addrs\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeRepeatedMessageField(value: &self.wgEndpointAddrs) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.wgEndpointAddrs.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.wgEndpointAddrs, fieldNumber: 5)
    }
  ...
  static func ==(lhs: Border0_Common_V1_DiscoveryDetailsMessage, rhs: Border0_Common_V1_DiscoveryDetailsMessage) -> Bool {
    ...
    if lhs.wgEndpointAddrs != rhs.wgEndpointAddrs {return false}
