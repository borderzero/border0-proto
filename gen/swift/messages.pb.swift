...
enum Border0_Common_V1_IPAddressScope: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case `private` // = 0
  case `public` // = 1
  case UNRECOGNIZED(Int)
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Border0_Common_V1_IPAddressScope] = [
    .private,
    .public,
  ]
...
struct Border0_Common_V1_DiscoveryDetailsMessage: Sendable {
  ...
  var addresses: [Border0_Common_V1_IPAddrPort] = []
...
struct Border0_Common_V1_IPAddrPort: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var ipVersion: Border0_Common_V1_IPAddressType = .ipv4

  var ipScope: Border0_Common_V1_IPAddressScope = .private
...
extension Border0_Common_V1_IPAddressScope: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0PRIVATE\0\u{1}PUBLIC\0")
}
...
extension Border0_Common_V1_DiscoveryDetailsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}discoverable\0\u{3}endpoint_public_udp4\0\u{3}endpoint_public_udp6\0\u{3}public_key\0\u{1}addresses\0")
...
extension Border0_Common_V1_WireGuardPeer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}public_key\0\u{1}ipv4\0\u{1}ipv6\0\u{3}allowed_ips\0\u{3}persistent_keepalive_interval_seconds\0\u{3}public_udp4_endpoint\0\u{3}public_udp6_endpoint\0\u{1}type\0\u{1}services\0\u{1}name\0\u{1}addresses\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 11: try { try decoder.decodeRepeatedMessageField(value: &self.addresses) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.addresses.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.addresses, fieldNumber: 11)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Border0_Common_V1_IPAddrPort: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".IPAddrPort"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}ip_address\0\u{3}ip_version\0\u{3}ip_scope\0\u{1}port\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.ipAddress) }()
      case 2: try { try decoder.decodeSingularEnumField(value: &self.ipVersion) }()
      case 3: try { try decoder.decodeSingularEnumField(value: &self.ipScope) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.ipVersion != .ipv4 {
      try visitor.visitSingularEnumField(value: self.ipVersion, fieldNumber: 2)
    }
    if self.ipScope != .private {
      try visitor.visitSingularEnumField(value: self.ipScope, fieldNumber: 3)
    }
    if self.port != 0 {
  ...
  static func ==(lhs: Border0_Common_V1_IPAddrPort, rhs: Border0_Common_V1_IPAddrPort) -> Bool {
    if lhs.ipAddress != rhs.ipAddress {return false}
    if lhs.ipVersion != rhs.ipVersion {return false}
    if lhs.ipScope != rhs.ipScope {return false}
