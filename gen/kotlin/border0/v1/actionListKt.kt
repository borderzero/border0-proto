...
@kotlin.jvm.JvmName("-initializeactionList")
public inline fun actionList(block: border0.v1.actionListKt.Dsl.() -> kotlin.Unit): border0.v1.Connector.actionList =
  border0.v1.actionListKt.Dsl._create(border0.v1.Connector.actionList.newBuilder()).apply { block() }._build()
public object actionListKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: border0.v1.Connector.actionList.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: border0.v1.Connector.actionList.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): border0.v1.Connector.actionList = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun border0.v1.Connector.actionList.copy(block: border0.v1.actionListKt.Dsl.() -> kotlin.Unit): border0.v1.Connector.actionList =
  border0.v1.actionListKt.Dsl._create(this.toBuilder()).apply { block() }._build()
