...
type DiscoveryDetailsMessage struct {
	...
	EndpointPublicUdp4 string                   `protobuf:"bytes,2,opt,name=endpoint_public_udp4,json=endpointPublicUdp4,proto3" json:"endpoint_public_udp4,omitempty"` // the peer's public IP WireGuard endpoint (IPv4 + port) discovered via STUN
	EndpointPublicUdp6 string                   `protobuf:"bytes,3,opt,name=endpoint_public_udp6,json=endpointPublicUdp6,proto3" json:"endpoint_public_udp6,omitempty"` // the peer's public IP WireGuard endpoint (IPv6 + port) discovered via STUN
	...
	WgEpAddrs          []*WireGuardEndpointAddr `protobuf:"bytes,5,rep,name=wg_ep_addrs,json=wgEpAddrs,proto3" json:"wg_ep_addrs,omitempty"`                            // all ip address and port combinations that the peer can use to tx/rx traffic
}
...
func (x *DiscoveryDetailsMessage) GetWgEpAddrs() []*WireGuardEndpointAddr {
	if x != nil {
		return x.WgEpAddrs
	}
	return nil
...
type SplitDNSRule struct {
	...
	Domain     string   `protobuf:"bytes,1,opt,name=domain,proto3" json:"domain,omitempty"`                           // Domain pattern (e.g., "example.com")
	DnsServers []string `protobuf:"bytes,2,rep,name=dns_servers,json=dnsServers,proto3" json:"dns_servers,omitempty"` // DNS servers to use for this domain
}

func (x *SplitDNSRule) Reset() {
	*x = SplitDNSRule{}
	if protoimpl.UnsafeEnabled {
...
func (x *SplitDNSRule) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SplitDNSRule) ProtoMessage() {}

func (x *SplitDNSRule) ProtoReflect() protoreflect.Message {
	mi := &file_messages_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SplitDNSRule.ProtoReflect.Descriptor instead.
func (*SplitDNSRule) Descriptor() ([]byte, []int) {
	return file_messages_proto_rawDescGZIP(), []int{8}
}

func (x *SplitDNSRule) GetDomain() string {
	if x != nil {
		return x.Domain
	}
	return ""
...
func (x *SplitDNSRule) GetDnsServers() []string {
	if x != nil {
		return x.DnsServers
	}
	return nil
...
type DNSConfigurationMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DnsManagementEnabled bool            `protobuf:"varint,1,opt,name=dns_management_enabled,json=dnsManagementEnabled,proto3" json:"dns_management_enabled,omitempty"` // Flag indicating if DNS management is enabled for the organization
	GlobalDnsServers     []string        `protobuf:"bytes,2,rep,name=global_dns_servers,json=globalDnsServers,proto3" json:"global_dns_servers,omitempty"`              // List of global DNS server IP addresses (IPv4/IPv6) to use for all queries
	SplitDnsRules        []*SplitDNSRule `protobuf:"bytes,3,rep,name=split_dns_rules,json=splitDnsRules,proto3" json:"split_dns_rules,omitempty"`                       // List of domain-specific DNS routing rules
}

func (x *DNSConfigurationMessage) Reset() {
	*x = DNSConfigurationMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *DNSConfigurationMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DNSConfigurationMessage) ProtoMessage() {}

func (x *DNSConfigurationMessage) ProtoReflect() protoreflect.Message {
	mi := &file_messages_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DNSConfigurationMessage.ProtoReflect.Descriptor instead.
func (*DNSConfigurationMessage) Descriptor() ([]byte, []int) {
	return file_messages_proto_rawDescGZIP(), []int{9}
}

func (x *DNSConfigurationMessage) GetDnsManagementEnabled() bool {
	if x != nil {
		return x.DnsManagementEnabled
	}
	return false
}

func (x *DNSConfigurationMessage) GetGlobalDnsServers() []string {
	if x != nil {
		return x.GlobalDnsServers
	}
	return nil
}

func (x *DNSConfigurationMessage) GetSplitDnsRules() []*SplitDNSRule {
	if x != nil {
		return x.SplitDnsRules
	}
	return nil
}
...
type NetworkStateMessage struct {
	...
	DnsConfiguration       *DNSConfigurationMessage `protobuf:"bytes,10,opt,name=dns_configuration,json=dnsConfiguration,proto3" json:"dns_configuration,omitempty"` // DNS configuration for the organization
}
...
func (x *NetworkStateMessage) GetDnsConfiguration() *DNSConfigurationMessage {
	if x != nil {
...
type WireGuardPeer struct {
	...
	WgEpAddrs                          []*WireGuardEndpointAddr `protobuf:"bytes,11,rep,name=wg_ep_addrs,json=wgEpAddrs,proto3" json:"wg_ep_addrs,omitempty"`                                                                              // all ip address and port combinations that the peer can use to tx/rx traffic
	...
	//
	// Deprecated: Marked as deprecated in messages.proto.
	PublicUdp4Endpoint string `protobuf:"bytes,6,opt,name=public_udp4_endpoint,json=publicUdp4Endpoint,proto3" json:"public_udp4_endpoint,omitempty"`
	// DEPRECATED: All addresses are now part of wg_ep_addrs.
	//
	// The peer's public IP WireGuard endpoint (IPv6 + port) discovered via STUN.
	//
	// Deprecated: Marked as deprecated in messages.proto.
	PublicUdp6Endpoint string `protobuf:"bytes,7,opt,name=public_udp6_endpoint,json=publicUdp6Endpoint,proto3" json:"public_udp6_endpoint,omitempty"`
}
...
func (x *WireGuardPeer) GetWgEpAddrs() []*WireGuardEndpointAddr {
	if x != nil {
		return x.WgEpAddrs
	}
	return nil
...
type Service struct {
	...
	DatabaseSettings    *DatabaseSettings        `protobuf:"bytes,14,opt,name=database_settings,json=databaseSettings,proto3" json:"database_settings,omitempty"`
	DnsPatterns         []string                 `protobuf:"bytes,15,rep,name=dns_patterns,json=dnsPatterns,proto3" json:"dns_patterns,omitempty"`                // DNS domain patterns to route through this service
	RdpProxyEnabled     bool                     `protobuf:"varint,16,opt,name=rdp_proxy_enabled,json=rdpProxyEnabled,proto3" json:"rdp_proxy_enabled,omitempty"` // if RDP upstream username and password are both set, this field will be true
}
...
func (x *Service) GetDnsPatterns() []string {
	if x != nil {
...
func (x *Service) GetRdpProxyEnabled() bool {
	if x != nil {
		return x.RdpProxyEnabled
	}
	return false
}
...
type WireGuardEndpointAddr struct {
	...
	IfaceName string `protobuf:"bytes,2,opt,name=iface_name,json=ifaceName,proto3" json:"iface_name,omitempty"` // the name of the local interface that has the address (e.g., "eth0"), empty if from_stun is true.
	IfaceCidr string `protobuf:"bytes,3,opt,name=iface_cidr,json=ifaceCidr,proto3" json:"iface_cidr,omitempty"` // the CIDR block this IP belongs to (e.g., "192.168.0.0/24"), empty if from_stun is true.
...
var file_messages_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x8a, 0x02, 0x0a, 0x17, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79,
	...
	,
	...
	,
	...
	,
	...
	0x50, 0x65, 0x65, 0x72, 0x52, 0x04, 0x70, 0x65, 0x65, 0x72, 0x22, 0x5b, 0x0a, 0x12, 0x50, 0x65,
	0x65, 0x72, 0x4f, 0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x22, 0x47, 0x0a, 0x0c, 0x53, 0x70, 0x6c, 0x69, 0x74,
	0x44, 0x4e, 0x53, 0x52, 0x75, 0x6c, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69,
	...
	,
	...
	,
	...
	0x69, 0x70, 0x76, 0x36, 0x12, 0x51, 0x0a, 0x25, 0x70, 0x65, 0x72, 0x73, 0x69, 0x73, 0x74, 0x65,
	...
	0x01, 0x28, 0x0d, 0x52, 0x22, 0x70, 0x65, 0x72, 0x73, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x74, 0x4b,
	0x65, 0x65, 0x70, 0x61, 0x6c, 0x69, 0x76, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c,
	0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x2f, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x62, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x30, 0x2e,
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x54, 0x79,
	0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x36, 0x0a, 0x08, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x62, 0x6f, 0x72,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x12, 0x48, 0x0a, 0x0b, 0x77, 0x67, 0x5f, 0x65, 0x70, 0x5f, 0x61, 0x64,
	0x64, 0x72, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x62, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x30, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x57, 0x69,
	0x72, 0x65, 0x47, 0x75, 0x61, 0x72, 0x64, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x41,
	0x64, 0x64, 0x72, 0x52, 0x09, 0x77, 0x67, 0x45, 0x70, 0x41, 0x64, 0x64, 0x72, 0x73, 0x12, 0x23,
	...
	,
	...
	,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x50, 0x0a, 0x11, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
	...
	,
	...
	,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x22, 0x53, 0x0a, 0x11, 0x44, 0x69,
	...
	,
	...
	0x52, 0x10, 0x02, 0x2a, 0x4d, 0x0a, 0x13, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63,
	...
	0x52, 0x5f, 0x53, 0x48, 0x55, 0x54, 0x44, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x14, 0x0a, 0x10,
	0x4e, 0x45, 0x57, 0x45, 0x52, 0x5f, 0x43, 0x4f, 0x4e, 0x4e, 0x45, 0x43, 0x54, 0x49, 0x4f, 0x4e,
	...
	0x65, 0x72, 0x30, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
...
var file_messages_proto_goTypes = []any{
	...
	(*SplitDNSRule)(nil),              // 11: border0.common.v1.SplitDNSRule
	(*DNSConfigurationMessage)(nil),   // 12: border0.common.v1.DNSConfigurationMessage
	(*NetworkStateMessage)(nil),       // 13: border0.common.v1.NetworkStateMessage
	(*WireGuardPeer)(nil),             // 14: border0.common.v1.WireGuardPeer
	(*DatabaseSettings)(nil),          // 15: border0.common.v1.DatabaseSettings
	(*Service)(nil),                   // 16: border0.common.v1.Service
	(*IPAddressWithMetadata)(nil),     // 17: border0.common.v1.IPAddressWithMetadata
	(*WireGuardEndpointAddr)(nil),     // 18: border0.common.v1.WireGuardEndpointAddr
	(*DisconnectMessage)(nil),         // 19: border0.common.v1.DisconnectMessage
	(*Group)(nil),                     // 20: border0.common.v1.Group
	nil,                               // 21: border0.common.v1.Service.TagsEntry
	(*timestamppb.Timestamp)(nil),     // 22: google.protobuf.Timestamp
	(*structpb.Struct)(nil),           // 23: google.protobuf.Struct
}
var file_messages_proto_depIdxs = []int32{
	18, // 0: border0.common.v1.DiscoveryDetailsMessage.wg_ep_addrs:type_name -> border0.common.v1.WireGuardEndpointAddr
	...
	22, // 3: border0.common.v1.NetworkDeviceStatsMessage.timestamp:type_name -> google.protobuf.Timestamp
	22, // 4: border0.common.v1.SocketStatsMessage.timestamp:type_name -> google.protobuf.Timestamp
	7,  // 5: border0.common.v1.SocketsStatsMessage.socket_stats:type_name -> border0.common.v1.SocketStatsMessage
	14, // 6: border0.common.v1.PeerOnlineMessage.peer:type_name -> border0.common.v1.WireGuardPeer
	11, // 7: border0.common.v1.DNSConfigurationMessage.split_dns_rules:type_name -> border0.common.v1.SplitDNSRule
	14, // 8: border0.common.v1.NetworkStateMessage.online_peers:type_name -> border0.common.v1.WireGuardPeer
	16, // 9: border0.common.v1.NetworkStateMessage.standalone_services:type_name -> border0.common.v1.Service
	12, // 10: border0.common.v1.NetworkStateMessage.dns_configuration:type_name -> border0.common.v1.DNSConfigurationMessage
	1,  // 11: border0.common.v1.WireGuardPeer.type:type_name -> border0.common.v1.PeerType
	16, // 12: border0.common.v1.WireGuardPeer.services:type_name -> border0.common.v1.Service
	18, // 13: border0.common.v1.WireGuardPeer.wg_ep_addrs:type_name -> border0.common.v1.WireGuardEndpointAddr
	21, // 14: border0.common.v1.Service.tags:type_name -> border0.common.v1.Service.TagsEntry
	17, // 15: border0.common.v1.Service.public_ips:type_name -> border0.common.v1.IPAddressWithMetadata
	15, // 16: border0.common.v1.Service.database_settings:type_name -> border0.common.v1.DatabaseSettings
	0,  // 17: border0.common.v1.IPAddressWithMetadata.type:type_name -> border0.common.v1.IPAddressType
	23, // 18: border0.common.v1.IPAddressWithMetadata.metadata:type_name -> google.protobuf.Struct
	2,  // 19: border0.common.v1.DisconnectMessage.reason:type_name -> border0.common.v1.DisconnectionReason
...
func file_messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_messages_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*DNSConfigurationMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
