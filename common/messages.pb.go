...
type IPAddressScope int32

const (
	IPAddressScope_PRIVATE IPAddressScope = 0
	IPAddressScope_PUBLIC  IPAddressScope = 1
)

// Enum value maps for IPAddressScope.
var (
	IPAddressScope_name = map[int32]string{
		0: "PRIVATE",
		1: "PUBLIC",
	}
	IPAddressScope_value = map[string]int32{
		"PRIVATE": 0,
		"PUBLIC":  1,
	}
)

func (x IPAddressScope) Enum() *IPAddressScope {
	p := new(IPAddressScope)
	*p = x
	return p
}

func (x IPAddressScope) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (IPAddressScope) Descriptor() protoreflect.EnumDescriptor {
	return file_messages_proto_enumTypes[1].Descriptor()
}

func (IPAddressScope) Type() protoreflect.EnumType {
	return &file_messages_proto_enumTypes[1]
}

func (x IPAddressScope) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use IPAddressScope.Descriptor instead.
func (IPAddressScope) EnumDescriptor() ([]byte, []int) {
...
type DiscoveryDetailsMessage struct {
	...
	Addresses          []*IPAddrPort `protobuf:"bytes,5,rep,name=addresses,proto3" json:"addresses,omitempty"`                                               // all ip address and port combinations that the peer can tx/rx traffic
}
...
func (x *DiscoveryDetailsMessage) GetAddresses() []*IPAddrPort {
	if x != nil {
		return x.Addresses
	}
	return nil
...
type WireGuardPeer struct {
	...
	Addresses          []*IPAddrPort `protobuf:"bytes,11,rep,name=addresses,proto3" json:"addresses,omitempty"`                                              // all ip address and port combinations that the peer can tx/rx traffic
}
...
func (x *WireGuardPeer) GetAddresses() []*IPAddrPort {
	if x != nil {
		return x.Addresses
	}
	return nil
...
type IPAddrPort struct {
	...
	IpAddress string         `protobuf:"bytes,1,opt,name=ip_address,json=ipAddress,proto3" json:"ip_address,omitempty"`
	IpVersion IPAddressType  `protobuf:"varint,2,opt,name=ip_version,json=ipVersion,proto3,enum=border0.common.v1.IPAddressType" json:"ip_version,omitempty"`
	IpScope   IPAddressScope `protobuf:"varint,3,opt,name=ip_scope,json=ipScope,proto3,enum=border0.common.v1.IPAddressScope" json:"ip_scope,omitempty"`
	Port      uint32         `protobuf:"varint,4,opt,name=port,proto3" json:"port,omitempty"`
}

func (x *IPAddrPort) Reset() {
	*x = IPAddrPort{}
	if protoimpl.UnsafeEnabled {
...
func (x *IPAddrPort) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IPAddrPort) ProtoMessage() {}

func (x *IPAddrPort) ProtoReflect() protoreflect.Message {
	mi := &file_messages_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IPAddrPort.ProtoReflect.Descriptor instead.
func (*IPAddrPort) Descriptor() ([]byte, []int) {
	return file_messages_proto_rawDescGZIP(), []int{12}
}

func (x *IPAddrPort) GetIpAddress() string {
	if x != nil {
		return x.IpAddress
	}
	return ""
...
func (x *IPAddrPort) GetIpVersion() IPAddressType {
	if x != nil {
		return x.IpVersion
	}
	return IPAddressType_IPV4
...
func (x *IPAddrPort) GetIpScope() IPAddressScope {
	if x != nil {
		return x.IpScope
	}
	return IPAddressScope_PRIVATE
}

func (x *IPAddrPort) GetPort() uint32 {
	if x != nil {
		return x.Port
	}
	return 0
...
var file_messages_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x85, 0x02, 0x0a, 0x17, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79,
	...
	,
	...
	,
	...
	,
	...
	0x04, 0x70, 0x65, 0x65, 0x72, 0x22, 0x5b, 0x0a, 0x12, 0x50, 0x65, 0x65, 0x72, 0x4f, 0x66, 0x66,
	0x6c, 0x69, 0x6e, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x6e,
	0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x0f, 0x70, 0x65,
	...
	0x65, 0x79, 0x22, 0xc6, 0x03, 0x0a, 0x13, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x53, 0x74,
	0x61, 0x74, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x6e, 0x65,
	0x74, 0x77, 0x6f, 0x72, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x0f, 0x6e, 0x65, 0x74,
	0x77, 0x6f, 0x72, 0x6b, 0x5f, 0x63, 0x69, 0x64, 0x72, 0x5f, 0x76, 0x34, 0x18, 0x02, 0x20, 0x01,
	...
	,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x16, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x52,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x43, 0x69, 0x64, 0x72, 0x56, 0x36, 0x12, 0x4b,
	0x0a, 0x13, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x61, 0x6c, 0x6f, 0x6e, 0x65, 0x5f, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x62, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x30, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x12, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x61, 0x6c,
	0x6f, 0x6e, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x22, 0xf4, 0x03, 0x0a, 0x0d,
	...
	0x69, 0x70, 0x76, 0x36, 0x12, 0x23, 0x0a, 0x0b, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x5f,
	0x69, 0x70, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0a, 0x61,
	0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x49, 0x70, 0x73, 0x12, 0x51, 0x0a, 0x25, 0x70, 0x65, 0x72,
	...
	,
	...
	,
	...
	,
	...
	0x67, 0x73, 0x12, 0x47, 0x0a, 0x0a, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x69, 0x70, 0x73,
	0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x62, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x30,
	0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x50, 0x41, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x57, 0x69, 0x74, 0x68, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0x52, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x49, 0x70, 0x73, 0x1a, 0x37, 0x0a, 0x09, 0x54,
	...
	,
...
var file_messages_proto_goTypes = []any{
	...
	(IPAddressScope)(0),               // 1: border0.common.v1.IPAddressScope
	(PeerType)(0),                     // 2: border0.common.v1.PeerType
	(DisconnectionReason)(0),          // 3: border0.common.v1.DisconnectionReason
	(*DiscoveryDetailsMessage)(nil),   // 4: border0.common.v1.DiscoveryDetailsMessage
	(*HeartbeatMessage)(nil),          // 5: border0.common.v1.HeartbeatMessage
	(*StatsMessage)(nil),              // 6: border0.common.v1.StatsMessage
	(*NetworkDeviceStatsMessage)(nil), // 7: border0.common.v1.NetworkDeviceStatsMessage
	(*SocketStatsMessage)(nil),        // 8: border0.common.v1.SocketStatsMessage
	(*SocketsStatsMessage)(nil),       // 9: border0.common.v1.SocketsStatsMessage
	(*PeerOnlineMessage)(nil),         // 10: border0.common.v1.PeerOnlineMessage
	(*PeerOfflineMessage)(nil),        // 11: border0.common.v1.PeerOfflineMessage
	(*NetworkStateMessage)(nil),       // 12: border0.common.v1.NetworkStateMessage
	(*WireGuardPeer)(nil),             // 13: border0.common.v1.WireGuardPeer
	(*Service)(nil),                   // 14: border0.common.v1.Service
	(*IPAddressWithMetadata)(nil),     // 15: border0.common.v1.IPAddressWithMetadata
	(*IPAddrPort)(nil),                // 16: border0.common.v1.IPAddrPort
...
var file_messages_proto_depIdxs = []int32{
	16, // 0: border0.common.v1.DiscoveryDetailsMessage.addresses:type_name -> border0.common.v1.IPAddrPort
	7,  // 1: border0.common.v1.StatsMessage.network_device_stats:type_name -> border0.common.v1.NetworkDeviceStatsMessage
	9,  // 2: border0.common.v1.StatsMessage.sockets_stats:type_name -> border0.common.v1.SocketsStatsMessage
	...
	8,  // 5: border0.common.v1.SocketsStatsMessage.socket_stats:type_name -> border0.common.v1.SocketStatsMessage
	13, // 6: border0.common.v1.PeerOnlineMessage.peer:type_name -> border0.common.v1.WireGuardPeer
	13, // 7: border0.common.v1.NetworkStateMessage.online_peers:type_name -> border0.common.v1.WireGuardPeer
	14, // 8: border0.common.v1.NetworkStateMessage.standalone_services:type_name -> border0.common.v1.Service
	2,  // 9: border0.common.v1.WireGuardPeer.type:type_name -> border0.common.v1.PeerType
	14, // 10: border0.common.v1.WireGuardPeer.services:type_name -> border0.common.v1.Service
	16, // 11: border0.common.v1.WireGuardPeer.addresses:type_name -> border0.common.v1.IPAddrPort
	...
	21, // 15: border0.common.v1.IPAddressWithMetadata.metadata:type_name -> google.protobuf.Struct
	0,  // 16: border0.common.v1.IPAddrPort.ip_version:type_name -> border0.common.v1.IPAddressType
	1,  // 17: border0.common.v1.IPAddrPort.ip_scope:type_name -> border0.common.v1.IPAddressScope
	3,  // 18: border0.common.v1.DisconnectMessage.reason:type_name -> border0.common.v1.DisconnectionReason
