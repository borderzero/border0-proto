...
struct Border0_V1_ControlStreamRequest: Sendable {
  ...
  var session: Border0_V1_SessionCreateRequest {
    get {
      if case .session(let v)? = requestType {return v}
      return Border0_V1_SessionCreateRequest()
    }
  ...
  enum OneOf_RequestType: Equatable, Sendable {
    ...
    case session(Border0_V1_SessionCreateRequest)
...
struct Border0_V1_ControlStreamResponse: Sendable {
  ...
  var session: Border0_V1_SessionCreateResponse {
    get {
      if case .session(let v)? = requestType {return v}
      return Border0_V1_SessionCreateResponse()
    }
    set {requestType = .session(newValue)}
  }
  ...
  enum OneOf_RequestType: Equatable, Sendable {
    ...
    case session(Border0_V1_SessionCreateResponse)
...
struct Border0_V1_SessionCreateRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Border0_V1_SessionCreateResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Border0_V1_ControlStreamRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 16: try {
        var v: Border0_V1_SessionCreateRequest?
        var hadOneofValue = false
        if let current = self.requestType {
          hadOneofValue = true
...
extension Border0_V1_ControlStreamResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 16: try {
        var v: Border0_V1_SessionCreateResponse?
        var hadOneofValue = false
        if let current = self.requestType {
          hadOneofValue = true
          if case .session(let m) = current {v = m}
...
extension Border0_V1_SessionCreateRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SessionCreateRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "request_id"),
  ...
  static func ==(lhs: Border0_V1_SessionCreateRequest, rhs: Border0_V1_SessionCreateRequest) -> Bool {
...
extension Border0_V1_SessionCreateResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SessionCreateResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "request_id"),
  ...
  static func ==(lhs: Border0_V1_SessionCreateResponse, rhs: Border0_V1_SessionCreateResponse) -> Bool {
    if lhs.requestID != rhs.requestID {return false}
