...
func (x *WatchMessagesRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ControlStreamRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ControlStreamRequest) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *ControlStreamReponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_connector_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x0a, 0x62, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x30, 0x2e, 0x76, 0x31, 0x22, 0x21, 0x0a,
	...
	0x61, 0x67, 0x65, 0x22, 0x26, 0x0a, 0x14, 0x57, 0x61, 0x74, 0x63, 0x68, 0x4d, 0x65, 0x73, 0x73,
	...
	,
...
var file_connector_proto_goTypes = []interface{}{
	(*RegisterRequest)(nil),      // 0: border0.v1.RegisterRequest
	(*RegisterResponse)(nil),     // 1: border0.v1.RegisterResponse
	(*Message)(nil),              // 2: border0.v1.Message
	(*WatchMessagesRequest)(nil), // 3: border0.v1.WatchMessagesRequest
	(*ControlStreamRequest)(nil), // 4: border0.v1.ControlStreamRequest
	(*ControlStreamReponse)(nil), // 5: border0.v1.ControlStreamReponse
}
var file_connector_proto_depIdxs = []int32{
	0, // 0: border0.v1.ConnectorService.Register:input_type -> border0.v1.RegisterRequest
	3, // 1: border0.v1.ConnectorService.WatchMessages:input_type -> border0.v1.WatchMessagesRequest
	4, // 2: border0.v1.ConnectorService.ControlStream:input_type -> border0.v1.ControlStreamRequest
	1, // 3: border0.v1.ConnectorService.Register:output_type -> border0.v1.RegisterResponse
	2, // 4: border0.v1.ConnectorService.WatchMessages:output_type -> border0.v1.Message
	5, // 5: border0.v1.ConnectorService.ControlStream:output_type -> border0.v1.ControlStreamReponse
...
func file_connector_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_connector_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WatchMessagesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
