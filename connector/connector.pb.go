...
func (x *ControlStreamResponse) GetStats() *common.StatsMessage {
	if x, ok := x.GetRequestType().(*ControlStreamResponse_Stats); ok {
		return x.Stats
	}
	return nil
}
...
type ControlStreamResponse_Stats struct {
...
func (*ControlStreamResponse_Stats) isControlStreamResponse_RequestType() {}
...
var file_connector_proto_rawDesc = []byte{
	...
	0x8f, 0x09, 0x0a, 0x15, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x53, 0x74, 0x72, 0x65, 0x61,
	...
	0x52, 0x07, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x37, 0x0a, 0x05, 0x73, 0x74, 0x61,
	0x74, 0x73, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x62, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x30, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x74, 0x61,
	0x74, 0x73, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x48, 0x00, 0x52, 0x05, 0x73, 0x74, 0x61,
	0x74, 0x73, 0x42, 0x0d, 0x0a, 0x0b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x54, 0x79, 0x70,
...
var file_connector_proto_goTypes = []any{
	...
	(*common.StatsMessage)(nil),            // 43: border0.common.v1.StatsMessage
...
var file_connector_proto_depIdxs = []int32{
	...
	43, // 30: border0.v1.ControlStreamResponse.stats:type_name -> border0.common.v1.StatsMessage
...
func file_connector_proto_init() {
	...
	file_connector_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*ControlStreamResponse_Stats)(nil),
	}
