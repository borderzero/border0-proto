...
func (x *SessionUpdateRequest) GetAuthInfo() string {
	if x != nil {
		return x.AuthInfo
	}
	return ""
...
func (x *SessionUpdateRequest) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_connector_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcf, 0x04, 0x0a,
	...
	0x52, 0x0d, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42,
	0x0d, 0x0a, 0x0b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0xe2,
	0x04, 0x0a, 0x14, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	...
	0x02, 0x38, 0x01, 0x22, 0x9c, 0x01, 0x0a, 0x14, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x55,
	...
	0x52, 0x08, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x61, 0x75, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x61, 0x75, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x12,
	0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61,
	0x74, 0x61, 0x2a, 0x37, 0x0a, 0x06, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0a, 0x0a, 0x06,
...
var file_connector_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_connector_proto_goTypes = []interface{}{
	...
	nil,                                    // 27: border0.v1.AuthorizeResponse.AllowedActionsEntry
	nil,                                    // 28: border0.v1.AuthorizeResponse.InfoEntry
...
var file_connector_proto_depIdxs = []int32{
	...
	6,  // 8: border0.v1.ControlStreamReponse.init:type_name -> border0.v1.Init
	17, // 9: border0.v1.ControlStreamReponse.connector_config:type_name -> border0.v1.ConnectorConfig
	7,  // 10: border0.v1.ControlStreamReponse.update_config:type_name -> border0.v1.UpdateConfig
	12, // 11: border0.v1.ControlStreamReponse.heartbeat:type_name -> border0.v1.HeartbeatResponse
	5,  // 12: border0.v1.ControlStreamReponse.tunnel_certificate_sign_response:type_name -> border0.v1.TunnelCertificateSignResponse
	19, // 13: border0.v1.ControlStreamReponse.discover:type_name -> border0.v1.Discover
	20, // 14: border0.v1.ControlStreamReponse.stop:type_name -> border0.v1.Stop
	21, // 15: border0.v1.ControlStreamReponse.disconnect:type_name -> border0.v1.Disconnect
	25, // 16: border0.v1.ControlStreamReponse.authorize:type_name -> border0.v1.AuthorizeResponse
	29, // 17: border0.v1.Organization.certificates:type_name -> google.protobuf.Struct
	17, // 18: border0.v1.Init.connector_config:type_name -> border0.v1.ConnectorConfig
	16, // 19: border0.v1.Init.sockets:type_name -> border0.v1.SocketConfig
	18, // 20: border0.v1.Init.plugins:type_name -> border0.v1.PluginConfig
	0,  // 21: border0.v1.UpdateConfig.action:type_name -> border0.v1.Action
	18, // 22: border0.v1.UpdateConfig.plugin_config:type_name -> border0.v1.PluginConfig
	16, // 23: border0.v1.UpdateConfig.socket_config:type_name -> border0.v1.SocketConfig
	30, // 24: border0.v1.Log.timestamp:type_name -> google.protobuf.Timestamp
	29, // 25: border0.v1.ConnectorMetadata.data:type_name -> google.protobuf.Struct
	14, // 26: border0.v1.PluginDiscoveryResults.metadata:type_name -> border0.v1.PluginDiscoveryResultsMetadata
	29, // 27: border0.v1.PluginDiscoveryResults.resources:type_name -> google.protobuf.Struct
	30, // 28: border0.v1.PluginDiscoveryResultsMetadata.started_at:type_name -> google.protobuf.Timestamp
	30, // 29: border0.v1.PluginDiscoveryResultsMetadata.ended_at:type_name -> google.protobuf.Timestamp
	29, // 30: border0.v1.SocketConfig.config:type_name -> google.protobuf.Struct
	3,  // 31: border0.v1.ConnectorConfig.organization:type_name -> border0.v1.Organization
	29, // 32: border0.v1.PluginConfig.config:type_name -> google.protobuf.Struct
	27, // 33: border0.v1.AuthorizeResponse.allowed_actions:type_name -> border0.v1.AuthorizeResponse.AllowedActionsEntry
	28, // 34: border0.v1.AuthorizeResponse.info:type_name -> border0.v1.AuthorizeResponse.InfoEntry
	23, // 35: border0.v1.AuthorizeResponse.AllowedActionsEntry.value:type_name -> border0.v1.actionList
	24, // 36: border0.v1.AuthorizeResponse.InfoEntry.value:type_name -> border0.v1.infoList
	1,  // 37: border0.v1.ConnectorService.ControlStream:input_type -> border0.v1.ControlStreamRequest
	2,  // 38: border0.v1.ConnectorService.ControlStream:output_type -> border0.v1.ControlStreamReponse
