...
type AuthorizeResponse struct {
	...
	RequestId      string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	AllowedActions map[string]*StringList `protobuf:"bytes,2,rep,name=allowed_actions,json=allowedActions,proto3" json:"allowed_actions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *AuthorizeResponse) GetAllowedActions() map[string]*StringList {
	if x != nil {
...
func (x *AuthorizeResponse) GetInfo() map[string]string {
	if x != nil {
		return x.Info
	}
	return nil
...
var file_connector_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x84, 0x04, 0x0a,
	...
	0x72, 0x69, 0x7a, 0x65, 0x42, 0x0d, 0x0a, 0x0b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x54,
	0x79, 0x70, 0x65, 0x22, 0xe2, 0x04, 0x0a, 0x14, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x53,
	...
	0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65, 0x42, 0x0d, 0x0a, 0x0b, 0x52, 0x65, 0x71,
	...
	0x63, 0x6b, 0x65, 0x74, 0x49, 0x64, 0x22, 0x24, 0x0a, 0x0a, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67,
	0x4c, 0x69, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0xdf, 0x02, 0x0a,
	...
	,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x37, 0x0a, 0x09, 0x49, 0x6e, 0x66, 0x6f, 0x45, 0x6e, 0x74,
...
var file_connector_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_connector_proto_goTypes = []interface{}{
	...
	(*StringList)(nil),                     // 23: border0.v1.StringList
	(*AuthorizeResponse)(nil),              // 24: border0.v1.AuthorizeResponse
	nil,                                    // 25: border0.v1.AuthorizeResponse.AllowedActionsEntry
	nil,                                    // 26: border0.v1.AuthorizeResponse.InfoEntry
...
var file_connector_proto_depIdxs = []int32{
	...
	6,  // 7: border0.v1.ControlStreamReponse.init:type_name -> border0.v1.Init
	17, // 8: border0.v1.ControlStreamReponse.connector_config:type_name -> border0.v1.ConnectorConfig
	7,  // 9: border0.v1.ControlStreamReponse.update_config:type_name -> border0.v1.UpdateConfig
	12, // 10: border0.v1.ControlStreamReponse.heartbeat:type_name -> border0.v1.HeartbeatResponse
	5,  // 11: border0.v1.ControlStreamReponse.tunnel_certificate_sign_response:type_name -> border0.v1.TunnelCertificateSignResponse
	19, // 12: border0.v1.ControlStreamReponse.discover:type_name -> border0.v1.Discover
	20, // 13: border0.v1.ControlStreamReponse.stop:type_name -> border0.v1.Stop
	21, // 14: border0.v1.ControlStreamReponse.disconnect:type_name -> border0.v1.Disconnect
	24, // 15: border0.v1.ControlStreamReponse.authorize:type_name -> border0.v1.AuthorizeResponse
	27, // 16: border0.v1.Organization.certificates:type_name -> google.protobuf.Struct
	17, // 17: border0.v1.Init.connector_config:type_name -> border0.v1.ConnectorConfig
	16, // 18: border0.v1.Init.sockets:type_name -> border0.v1.SocketConfig
	18, // 19: border0.v1.Init.plugins:type_name -> border0.v1.PluginConfig
	0,  // 20: border0.v1.UpdateConfig.action:type_name -> border0.v1.Action
	18, // 21: border0.v1.UpdateConfig.plugin_config:type_name -> border0.v1.PluginConfig
	16, // 22: border0.v1.UpdateConfig.socket_config:type_name -> border0.v1.SocketConfig
	28, // 23: border0.v1.Log.timestamp:type_name -> google.protobuf.Timestamp
	27, // 24: border0.v1.ConnectorMetadata.data:type_name -> google.protobuf.Struct
	14, // 25: border0.v1.PluginDiscoveryResults.metadata:type_name -> border0.v1.PluginDiscoveryResultsMetadata
	27, // 26: border0.v1.PluginDiscoveryResults.resources:type_name -> google.protobuf.Struct
	28, // 27: border0.v1.PluginDiscoveryResultsMetadata.started_at:type_name -> google.protobuf.Timestamp
	28, // 28: border0.v1.PluginDiscoveryResultsMetadata.ended_at:type_name -> google.protobuf.Timestamp
	27, // 29: border0.v1.SocketConfig.config:type_name -> google.protobuf.Struct
	3,  // 30: border0.v1.ConnectorConfig.organization:type_name -> border0.v1.Organization
	27, // 31: border0.v1.PluginConfig.config:type_name -> google.protobuf.Struct
	25, // 32: border0.v1.AuthorizeResponse.allowed_actions:type_name -> border0.v1.AuthorizeResponse.AllowedActionsEntry
	26, // 33: border0.v1.AuthorizeResponse.info:type_name -> border0.v1.AuthorizeResponse.InfoEntry
	23, // 34: border0.v1.AuthorizeResponse.AllowedActionsEntry.value:type_name -> border0.v1.StringList
	1,  // 35: border0.v1.ConnectorService.ControlStream:input_type -> border0.v1.ControlStreamRequest
	2,  // 36: border0.v1.ConnectorService.ControlStream:output_type -> border0.v1.ControlStreamReponse
