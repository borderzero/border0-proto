...
type DeviceToServerMessage struct {
	...
	//	*DeviceToServerMessage_DeviceMetadataMessage
...
func (x *DeviceToServerMessage) GetDeviceMetadataMessage() *DeviceMetadataMessage {
	if x, ok := x.GetMessage().(*DeviceToServerMessage_DeviceMetadataMessage); ok {
		return x.DeviceMetadataMessage
	}
	return nil
}
...
type DeviceToServerMessage_DeviceMetadataMessage struct {
	DeviceMetadataMessage *DeviceMetadataMessage `protobuf:"bytes,4,opt,name=deviceMetadataMessage,proto3,oneof"`
}
...
func (*DeviceToServerMessage_DeviceMetadataMessage) isDeviceToServerMessage_Message() {}
...
type DeviceMetadataMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DeviceMetadataMessage) Reset() {
	*x = DeviceMetadataMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *DeviceMetadataMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeviceMetadataMessage) ProtoMessage() {}

func (x *DeviceMetadataMessage) ProtoReflect() protoreflect.Message {
	mi := &file_device_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeviceMetadataMessage.ProtoReflect.Descriptor instead.
func (*DeviceMetadataMessage) Descriptor() ([]byte, []int) {
	return file_device_proto_rawDescGZIP(), []int{11}
}

func (x *DeviceMetadataMessage) GetMetadata() *DeviceMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *DeviceMetadata) GetData() *structpb.Struct {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_device_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	0x57, 0x4e, 0x10, 0x01, 0x32, 0x82, 0x01, 0x0a, 0x17, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4d,
...
var file_device_proto_goTypes = []any{
	...
	(*DeviceMetadataMessage)(nil),        // 12: border0.device.v1.DeviceMetadataMessage
	(*DeviceMetadata)(nil),               // 13: border0.device.v1.DeviceMetadata
...
var file_device_proto_depIdxs = []int32{
	...
	12, // 3: border0.device.v1.DeviceToServerMessage.deviceMetadataMessage:type_name -> border0.device.v1.DeviceMetadataMessage
	3,  // 4: border0.device.v1.ServerToDeviceMessage.authChallengeMessage:type_name -> border0.device.v1.AuthChallengeMessage
	6,  // 5: border0.device.v1.ServerToDeviceMessage.heartbeatMessage:type_name -> border0.device.v1.HeartbeatMessage
	9,  // 6: border0.device.v1.ServerToDeviceMessage.networkStateMessage:type_name -> border0.device.v1.NetworkStateMessage
	7,  // 7: border0.device.v1.ServerToDeviceMessage.peerOnlineMessage:type_name -> border0.device.v1.PeerOnlineMessage
	8,  // 8: border0.device.v1.ServerToDeviceMessage.peerOfflineMessage:type_name -> border0.device.v1.PeerOfflineMessage
	11, // 9: border0.device.v1.ServerToDeviceMessage.disconnectMessage:type_name -> border0.device.v1.DisconnectMessage
	10, // 10: border0.device.v1.PeerOnlineMessage.peer:type_name -> border0.device.v1.WireGuardPeer
	10, // 11: border0.device.v1.NetworkStateMessage.onlinePeers:type_name -> border0.device.v1.WireGuardPeer
	0,  // 12: border0.device.v1.DisconnectMessage.reason:type_name -> border0.device.v1.DisconnectionReason
	13, // 13: border0.device.v1.DeviceMetadataMessage.metadata:type_name -> border0.device.v1.DeviceMetadata
	14, // 14: border0.device.v1.DeviceMetadata.data:type_name -> google.protobuf.Struct
	1,  // 15: border0.device.v1.DeviceManagementService.ControlStream:input_type -> border0.device.v1.DeviceToServerMessage
	2,  // 16: border0.device.v1.DeviceManagementService.ControlStream:output_type -> border0.device.v1.ServerToDeviceMessage
...
func file_device_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_device_proto_msgTypes[11].Exporter = func(v any, i int) any {
			switch v := v.(*DeviceMetadataMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_device_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*DeviceToServerMessage_DeviceMetadataMessage)(nil),
	}
