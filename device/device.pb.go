...
var file_device_proto_rawDesc = []byte{
	...
	0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x9d, 0x04, 0x0a, 0x15, 0x53, 0x65, 0x72,
	...
	0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12, 0x36, 0x0a, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x62, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x30,
	0x2e, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x48, 0x00, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x42, 0x09, 0x0a,
	...
	0x73, 0x6f, 0x6c, 0x76, 0x65, 0x64, 0x4e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0xc5, 0x01, 0x0a, 0x07,
	...
	0x4b, 0x65, 0x79, 0x32, 0x82, 0x01, 0x0a, 0x17, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4d, 0x61,
...
var file_device_proto_goTypes = []any{
	...
	(*common.NetworkStateMessage)(nil),     // 7: border0.common.v1.NetworkStateMessage
	(*common.PeerOnlineMessage)(nil),       // 8: border0.common.v1.PeerOnlineMessage
	(*common.PeerOfflineMessage)(nil),      // 9: border0.common.v1.PeerOfflineMessage
	(*common.DisconnectMessage)(nil),       // 10: border0.common.v1.DisconnectMessage
}
var file_device_proto_depIdxs = []int32{
	...
	6,  // 4: border0.device.v1.ServerToDeviceMessage.heartbeat:type_name -> border0.common.v1.HeartbeatMessage
	7,  // 5: border0.device.v1.ServerToDeviceMessage.network_state:type_name -> border0.common.v1.NetworkStateMessage
	8,  // 6: border0.device.v1.ServerToDeviceMessage.peer_online:type_name -> border0.common.v1.PeerOnlineMessage
	9,  // 7: border0.device.v1.ServerToDeviceMessage.peer_offline:type_name -> border0.common.v1.PeerOfflineMessage
	10, // 8: border0.device.v1.ServerToDeviceMessage.disconnect:type_name -> border0.common.v1.DisconnectMessage
	4,  // 9: border0.device.v1.ServerToDeviceMessage.service:type_name -> border0.device.v1.Service
	0,  // 10: border0.device.v1.DeviceManagementService.ControlStream:input_type -> border0.device.v1.DeviceToServerMessage
	1,  // 11: border0.device.v1.DeviceManagementService.ControlStream:output_type -> border0.device.v1.ServerToDeviceMessage
